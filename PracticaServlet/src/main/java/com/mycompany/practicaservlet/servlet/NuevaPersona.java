...
public class NuevaPersona extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Optional<String> valor = Optional.ofNullable(request.getParameter("nom"));
        String nom = valor.orElse("Parámetro nombre no encontrado");
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Nova persona</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>S'ha afegit una nova persona</h1>");
